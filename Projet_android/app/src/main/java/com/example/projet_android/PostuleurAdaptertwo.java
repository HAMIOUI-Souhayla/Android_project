...
public class PostuleurAdaptertwo extends RecyclerView.Adapter<PostuleurAdaptertwo.MyHolder> {
        ...
        public PostuleurAdaptertwo(Context context, List<Users> userlist, boolean isChat) {
        ...
        public void onBindViewHolder(@NonNull MyHolder holder, int position) {
            ...
            final String postuleurId = user.getId();
            holder.username.setText(user.getNom() +" "+ user.getPrénom());
